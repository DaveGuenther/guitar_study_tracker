                ...
                ui.navset_tab(
                    ...
                    ui.nav_panel(
                        ...
                        ui.markdown("""
                            ...
                            - Practice Sessions:<br>
                                - How much time do I practice each day/week, and what songs am I spending my time on?  Specifically for this, I also wanted to be able to post practice videos on some days and have those available<br>
                    ...
                    ui.nav_panel(
                        ...
                        ui.markdown("""
                            ...
                            When considering the Inspiration/Goals metrics, I had this image in my mind of a plaque with plates on it that each represent a song I want to learn.  It would form the bases of a sort of inspiration wall.
                            ...
                            The idea here would be to have each song I want to learn someday that I’ve heard featured as a plate on a wooden plaque background.  Each song can have multiple arrangements of differing difficulty levels, so really it’s the arrangement that I want to identify as a goal.  When the user clicks on the plate, a body of text opens up on the right with details about the song itself, and then a section for each arrangement that I want to learn.  

                            Clair de Lune is an example of a song that I love hearing, and the arrangement that I enjoy the most is far too advanced for my skill level.  But it’s a goal nevertheless.  Then I found a simplified arrangement that is still really hard, but in the realm of possible for me.  I want both arrangements and their sheet music links to show when I click on the Clair de Lune plate.
                    ...
                    ui.nav_panel(
                        ...
                        ui.markdown("""
                            I used the SQLAlchemy Object Relational Mapping (ORM) library to handle database read/write functions.  This meant I needed to define each table format in ORM friendly objects before querying anything.  I kept it simple and just extracted the raw tables, leaving the joining to python/pandas rather than work out all the processing code in SQL - I’m stronger in Python anyway.  However, I housed the database code inside its own classes to keep things portable.  Since I had a number of tables to manage, I created each tables data entry screen as a module.  This allowed for encapsulation of ui code for each specific table’s lookup-resolved view while sharing common elements like the basic table form UI and button functionality.  I’ve since become more capable at using modules, and I’m not entirely sure that this object oriented method of working with modules is better than just using the shiny modules themselves.  A full class diagram for the data entry app is located in the repository in the docs folder.
                    ...
                    ui.nav_panel(
                        ...
                        ui.markdown("""
                            ...
                            Shiny is heavily asynchronous.  This means that certain blocks of code are kicked off and run in the background, allowing the program to continue execution of other tasks.  Debugging this kind of code sometimes requires additional things like the built in debug mode, loggers, profilers, and plain print statements to understand the program’s flow order when something doesn’t seem to be working correctly.

                            One of the tools that I’ve seen with RShiny that I do hope to see in the Python version soon is the reactlog.  RShiny has this awesome profiler that runs while an RShiny app is running, and builds a visual reactive dependency graph.  I think that it’s essential toward rooting out and eliminating interdependent reactives or runaway reactivity.  I’ve dealt with a few of these situations while working on this project and in some cases I couldn’t resolve it until I drew my own dependency graph stepping through the code.  That exercise usually allowed me to “isolate()” the issues. 🙂  
                            ...
                            - For every arrangement_id:
                                - arrangement_song_details_server():</b> This provides details about each arrangement in a song.  Some songs have only one arrangement identified, and some (like Clair de Lune) have multiple arrangements.
                        ...
                        ui.markdown("""
                            ...
                            Two style adjustments that I enjoyed working on were the rosette image on the nav bar and the head stock on the end of the waffle chart on the session tab.  Fun fact, the images for these were from actual pictures of my daily driver (Yamaha CG-101MS) - of course with some Gimp work.
                    ...
                    ui.nav_panel(
                        ...
                        ui.markdown(
                            ...
                            - [Python](https://www.python.org/): Oh how I love thee.. :heart_eyes:
